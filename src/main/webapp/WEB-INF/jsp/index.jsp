...
$('#fetchAllRecords').click(function() {
    ...
    html+="<thead> <tr>  <th scope='col'>Order Id</th> <th scope='col'>Customer Latitude/Longitude</th> <th scope='col'>Courier Latitude/Longitude</th> <th scope='col'>OTP</th> <th scope='col'>Call Status</th>  <th scope='col'>Call Duration</th> <th scope='col'>Date</th><th scope='col'>RTO Reason</th> <th scope='col'>DT Reason</th><th scope='col'>Distance</th></tr> </thead> <tbody> ";
                for (var i = 0; i < t.length ; i++) {
                String
                  html+="<tr> <td onclick='tableFunction(this)' data-toggle='modal' data-target='#myModal' style='color:#0000ff'> <p id='trow"+i+"'>" + t[i].orderId  + "</p></td> <td> <p> " + t[i].custLat+","+t[i].custLong +"</p></td> <td> <p>  " + t[i].feLat +","+t[i].feLong + "</p></td> <td> <p> " +t[i].otp +"</p></td> <td> <p>  " + t[i].callStatus + "</p></td>  <td> <p> "+  t[i].callDuration  +" </p></td> <td> <p> "+  new Date(t[i].created).toString().split("GMT")[0]  +" </p></td><td> <p> "+  t[i].rtoReason  +" </p></td><td> <p> "+  t[i].dtReason  +" </p></td> <td> <p> "+  t[i].distance  +" </p></td></tr>"
                }
    html+="</tbody>";
    ...
    function fetchAllRecordsYellow(t) {
        $('#chart1').empty();
            ...
            html+="<thead> <tr>  <th scope='col'>Order Id</th> <th scope='col'>Customer Latitude/Longitude</th> <th scope='col'>Courier Latitude/Longitude</th> <th scope='col'>OTP</th> <th scope='col'>Call Status</th>  <th scope='col'>Call Duration</th> <th scope='col'>Date</th><th scope='col'>RTO Reason</th> <th scope='col'>DT Reason</th><th scope='col'>Distance</th><th scope='col'>Customer RTO Score</th><th scope='col'>Customer Can Tickets</th><th scope='col'>Percentage Fake</th></tr> </thead> <tbody> ";
                for (var i = 0; i < t.length ; i++) {
                  html+="<tr> <td onclick='tableFunction(this)' data-toggle='modal' data-target='#myModal'> <p id='trow"+i+"'>" + t[i].orderId  + "</p></td> <td> <p> " + t[i].custLat+","+t[i].custLong +"</p></td> <td> <p>  " + t[i].feLat +","+t[i].feLong + "</p></td> <td> <p> " +t[i].otp +"</p></td> <td> <p>  " + t[i].callStatus + "</p></td>  <td> <p> "+  t[i].callDuration  +" </p></td> <td> <p> "+  new Date(t[i].created).toString().split("GMT")[0]  +" </p></td><td> <p> "+  t[i].rtoReason  +" </p></td><td> <p> "+  t[i].dtReason  +" </p></td> <td> <p> "+  t[i].distance  +" </p></td> <td> <p> "+  t[i].customerRtoScore  +" </p></td> <td> <p> "+  t[i].customerCancellationTickets  +" </p></td> <td> <p> "+  t[i].probabilityRecommendation  +" </p></td></tr>"
                }
            html+="</tbody>";
